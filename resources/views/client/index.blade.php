							...
							<div class="section-container p-l-r">
								<div class="row">
									...
									<div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 text-center header-center">
										<div class="site-logo">
											<a href="index12.html">
												<img width="400" height="79" src="{{ asset('/client/media/logo-white.png') }}" alt="Ruper – Furniture HTML Theme" />
											</a>
										</div>
									</div>
						...
						<div id="content" class="site-content" role="main">
								...
								<div class="block block-sliders layout-12 color-white auto-height nav-center">
									<div class="slick-sliders" data-autoplay="false" data-dots="true" data-nav="false" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns1440="1" data-columns="1">
										<div class="item slick-slide">
											<div class="item-content">
												<div class="content-image">
													<img width="1920" height="1080" src="{{ asset('client/media/slider/31.jpg') }}" alt="Image Slider">
												</div>
										...
										<div class="item slick-slide">
											<div class="item-content">
												<div class="content-image">
													<img width="1920" height="1080" src="{{ asset('client/media/slider/32.jpg') }}" alt="Image Slider">
												</div>
												<div class="item-info horizontal-center vertical-middle">
													<div class="content text-center">
														<div class="subtitle-slider">Spring Collection</div>
										...
										<div class="item slick-slide">
											<div class="item-content">
												<div class="content-image">
													<img width="1920" height="1080" src="{{ asset('client/media/slider/33.jpg') }}" alt="Image Slider">
												</div>
												<div class="item-info horizontal-center vertical-middle">
													<div class="content text-center">
														<div class="subtitle-slider">Spring Collection</div>
										...
										<div class="row">
												...
												<div class="cat-item">
													<div class="cat-image">
														<a href="shop-grid-left.html">
															<img width="469" height="475" src="{{ asset('client/media/product/cat-27.jpg') }}" alt="Product Category">
														</a>
													</div>
													<div class="cat-title">
														<a href="shop-grid-left.html">
											...
											<div class="col-lg-3 col-md-6 md-b-10">
												<div class="cat-item">
													<div class="cat-image">
														<a href="shop-grid-left.html">
															<img width="469" height="475" src="{{ asset('client/media/product/cat-28.jpg') }}" alt="Product Category">
														</a>
													</div>
													<div class="cat-title">
														<a href="shop-grid-left.html">
											...
											<div class="col-lg-3 col-md-6 md-b-10">
												<div class="cat-item">
													<div class="cat-image">
														<a href="shop-grid-left.html">
															<img width="469" height="475" src="{{ asset('client/media/product/cat-29.jpg') }}" alt="Product Category">
														</a>
													</div>
													<div class="cat-title">
														<a href="shop-grid-left.html">
											...
											<div class="col-lg-3 col-md-6">
												<div class="cat-item">
													<div class="cat-image">
														<a href="shop-grid-left.html">
															<img width="469" height="475" src="{{ asset('client/media/product/cat-30.jpg') }}" alt="Product Category">
														</a>
													</div>
													<div class="cat-title">
														<a href="shop-grid-left.html">
															...
															<div class="items">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{ asset('client/media/product/5.jpg') }}" class="post-image" alt="">
																				<img width="600" height="600" src="{{ asset('client/media/product/5-2.jpg') }}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<div class="product-button">
																			<div class="btn-add-to-cart" data-title="Add to cart">
							...
							<section class="section top-border p-t-70 m-b-70">
								<div class="block block-banners banners-effect">
									<div class="block-title title-big"><h2>Rupper Exclusive Online Furniture Store</h2></div>
									<div class="block-content">
											...
											<div class="banners">
												<div class="row">
													<div class="col-md-6">
														<div class="banner-image">
															<a href="shop-grid-left.html">
																<img width="961" height="590" src="{{ asset('client/media/banner/banner-25.jpg')}}" alt="Banner Image">
															</a>
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="banner-image">
															<a href="shop-grid-left.html">
																<img width="961" height="590" src="{{ asset('client/media/banner/banner-26.jpg') }}" alt="Banner Image">
															</a>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-6">
														<div class="banner-image">
															<a href="shop-grid-left.html">
																<img width="961" height="590" src="{{ asset('client/media/banner/banner-27.jpg') }}" alt="Banner Image">
															</a>
														</div>
													</div>
													<div class="col-md-6 banner-infor">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="banner-image">
															<a href="shop-grid-left.html">
																<img width="961" height="590" src="{{ asset('client/media/banner/banner-28.jpg') }}" alt="Banner Image">
															</a>
														</div>
													</div>
												</div>
													...
													<div class="slick-sliders" data-slidestoscroll="true" data-nav="1" data-dots="0" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1">
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	<div class="thumbnail">
																		<img width="62" height="62" src="{{ asset('client/media/testimonial/1.jpg')}}" alt="">
																	</div>
														...
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	<div class="thumbnail">
																		<img width="62" height="62" src="{{ asset('client/media/testimonial/2.jpg') }}" alt="">
																	</div>
																	<div class="testimonial-info">
														...
														<div class="testimonial-content">
															<div class="item">
																...
																<div class="testimonial-image image-position-top">
																	<div class="thumbnail">
																		<img width="62" height="62" src="{{ asset('client/media/testimonial/3.jpg') }}" alt="">
																	</div>
																	<div class="testimonial-info">
							...
							<tbody>
								<tr class="wishlist-item">
									...
									<td class="wishlist-item-image">
                                    	<a href="shop-details.html">
											<img width="600" height="600" src="{{ asset('client/media/product/3.jpg') }}" alt="">
										</a>
		                       		</td>
								...
								<tr class="wishlist-item">
									...
									<td class="wishlist-item-image">
                                    	<a href="shop-details.html">
											<img width="600" height="600" src="{{ asset('client/media/product/4.jpg') }}" alt="">
										</a>
		                       		</td>
			                        <td class="wishlist-item-info">
										<div class="wishlist-item-name">
                    		...
                    		<table id="product-table" class="product-table">
                    			...
                    			<tbody>
                    				<tr class="tr-image">
                    					...
                    					<td>
                    						<a href="shop-details.html">
                    							<img width="600" height="600" src="{{ asset('client/media/product/1.jpg') }}" alt="">
                    						</a>
                    					</td>
                    					<td>
                    						<a href="shop-details.html">
                    							<img width="600" height="600" src="{{ asset('client/media/product/2.jpg') }}" alt="">
                    						</a>
                    					</td>
                    				</tr>
                    				<tr class="tr-sku">
													...
													<div class="slick-wrap">
														<div class="slick-sliders image-additional" data-dots="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
															<div class="img-thumbnail slick-slide">
																<a href="{{ asset('client/media/product/3.jpg') }}" class="image-scroll" title="">
																	<img width="900" height="900" src="{{ asset('client/media/product/3.jpg') }}" alt="">
																</a>
															</div>
															<div class="img-thumbnail slick-slide">
																<a href="{{ asset('client/media/product/3-2.jpg') }}" class="image-scroll" title="">
																	<img width="900" height="900" src="{{ asset('client/media/product/3-2.jpg') }}" alt="">
																</a>
															</div>
														</div>
													</div>
